...
var apiRoutes = ApiRoutes{
	...
	{
		strings.ToUpper("POST"),
		"/owe-commisions-service/v1/create_leads",
	...
	{
		strings.ToUpper("POST"),
		"/owe-commisions-service/v1/get_leads_count_by_status",
	...
	{
		strings.ToUpper("POST"),
		"/owe-commisions-service/v1/get_leads",
	...
	{
		strings.ToUpper("POST"),
		"/owe-commisions-service/v1/leads_history",
	...
	// {
	// 	strings.ToUpper("POST"),
	// 	"/owe-commisions-service/v1/sent_appointment",
