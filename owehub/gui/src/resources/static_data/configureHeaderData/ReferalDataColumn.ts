...
export   const ReferalDataColumn: Column[] = [
    { name: "new_customer", displayName: "New Cust", type: "string",isCheckbox:true },
    { name: "referrer_s#", displayName: "Referrer S#", type: "string",isCheckbox:false},
    { name: "referrer_name", displayName: "Referrer Name", type: "string",isCheckbox:false },
   ...
   { name: "r1_rebet_credit$", displayName: "R1 Rebete Credit $", type: "string" ,isCheckbox:false},
   { name: "r1_rebet_credit%", displayName: "R1 Rebete Credit %", type: "string" ,isCheckbox:false},
   ...
   { name: "r2_rebet_credit$", displayName: "R1 Rebete Credit $", type: "string" ,isCheckbox:false},
   { name: "r2_rebet_credit%", displayName: "R2 Rebete Credit %", type: "string" ,isCheckbox:false},
