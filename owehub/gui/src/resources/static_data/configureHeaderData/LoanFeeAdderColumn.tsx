...
export const LoanFeeAdderColumns: Column[] = [
    ...
    { name: "dlr_tier", displayName: "Dlr Tier", type: "string", isCheckbox: false },
    { name: "owe_cost", displayName: "Owe Cost", type: "number", isCheckbox: false },
    { name: "addr_amt", displayName: "Addr Amt", type: "number", isCheckbox: false },
