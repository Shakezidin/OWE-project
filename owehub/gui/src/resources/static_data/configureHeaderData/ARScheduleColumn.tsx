...
export   const ARScheduleColumns: Column[] = [
    ...
    { name: "red_line", displayName: "Red Line", type: "string",isCheckbox:false },
    { name: "calc_date", displayName: "Calc Date", type: "string",isCheckbox:false },
    { name: "permit_pay", displayName: "Permit Pay", type: "string",isCheckbox:false },
