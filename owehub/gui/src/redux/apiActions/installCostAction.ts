...
export const getInstallCost = createAsyncThunk("fetch/installCost",async(param:Ipaginate,{rejectWithValue})=>{
    try {
...
export const createInstallCost = createAsyncThunk("create/installCost",async(params:ICostCreateparam,{rejectWithValue})=>{
    try {
