...
import { createAdderResponsibility,fetchAdderResponsibility,updateAdderResponsibility} from "../../../apiActions/adderResponsbilityAction";
...
const adderResponsibility = createSlice({
    ...
    extraReducers: builder => {
        builder.addCase(fetchAdderResponsibility.pending, (state) => {
            state.isLoading = true
        })
            .addCase(fetchAdderResponsibility.fulfilled, (state, action: PayloadAction<any | null>) => {
