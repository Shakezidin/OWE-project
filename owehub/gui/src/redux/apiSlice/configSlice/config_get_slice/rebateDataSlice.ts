...
import { fetchRebateData, createRebateData, updateRebateData} from "../../../apiActions/rebateDataAction"
...
const rebateDataSlice = createSlice({
    ...
    extraReducers: builder => {
        builder.addCase(fetchRebateData.pending, (state) => {
            state.isLoading = true
        })
            .addCase(fetchRebateData.fulfilled, (state, action: PayloadAction<any | null>) => {
