    ...
    <div style={{width:"100%",backgroundColor: "rgba(0, 0, 0, 0.72"
        ...
        <div className={styles.popUp}>
            <div className={styles.popUp_Header}>
                ...
                <p className={styles.popUp_cost}>Cost <div className={styles.popUp_cross} onClick={()=>setOpenPopUp(false)}><RxCross2 /></div></p>
                    ...
                    dummyObj.map((item,index)=>{
                        return(
                            <div className={styles.popUp_dummyData_rowDiv}>
                                ...
                                <div className={styles.popUp_quantityData}>{item.quantity} </div>
