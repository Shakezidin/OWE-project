    ...
    return (
        <div className='pen-rev'>
            <div className='pen-rev-top'>
                ...
                <div className='pr-sorting'onClick={toggleDropdown} ref={dropdownRef}><img src={ICONS.Sorting} alt="" /></div>
                ...
                <div className='pen-rev-bot-sec'>
                    <div className='pr-per-det'>
                        <div className='pr-perdet'>
                            <div className='pr-loc-name' style={{ backgroundColor: "#EBF3FF" }}>
                                <span>JM</span>
                            </div>
                            <p>Jacob Martin</p>
                        </div>
                        ...
                        <div className='pr-perdet'>
                            <div className='pr-loc-fol' style={{ backgroundColor: "#EEEBFF" }}>
                        ...
                        <div className='pr-perdet'>
                            <div className='pr-loc-fol' style={{ backgroundColor: "#EBF3FF" }}>
