...
import { installerOption, partnerOption, stateOption } from '../../../../core/models/data_models/SelectDataModel';
...
const CommissionForm:React.FC<formProps> = ({handleClose,handleSubmit,
  newFormData,
  createCommission,
  editMode,handleChange,handleInputChange,errors}) => {
  return (
          ...
          <div className="createProfileTextView">
            <div className="create-input-container">
              ...
              <div className="create-input-field">
                ...
                <div className="">
                  ...
                  />
                  {errors.installer && <span className="error">{errors.installer}</span>}
                </div>
              </div>
              <div className="create-input-field">
            ...
            <div className="create-input-container">
              <div className="create-input-field">
                ...
                />
              {errors.sale_type && <span className="error">{errors.sale_type}</span>}
              </div>
              <div className="create-input-field">
                <Input
                  type={"number"}
                  ...
                  onChange={(e) => handleInputChange(e)}
                />
                {errors.sale_price && <span className="error">{errors.sale_price}</span>} 
              </div>
              <div className="create-input-field">
                ...
                />
                 {errors.rep_type && <span className="error">{errors.rep_type}</span>}
              </div>
            </div>
            <div className="create-input-container">
