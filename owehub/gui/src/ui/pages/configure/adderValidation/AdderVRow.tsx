...
const AdderVRow:React.FC<rowProps> = ({selectAllChecked,selectedRows,isAllRowsSelected,isAnyRowSelected,
  setSelectAllChecked,setSelectedRows,viewArchived,
  currentPageData,
handleSort,
  handleArchiveClick,
  handleEdit,
             ...
             <CheckBox
              ...
              <td>
                <div className="action-icon">
                  ...
                  <div className="action-archive" style={{ cursor: "pointer" }} onClick={() => handleEdit(el)}>
