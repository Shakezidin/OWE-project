...
const WarningPopup = ({
  ...
  return (
    <div className="transparent-model px2 scrollbar">
      <div style={{border:"2px solid #D3D3D3"}} className=" modal py3 px2 relative">
        <div className="absolute pointer" onClick={handleClose} style={{right:20,top:17}}>
        ...
        <div className="text-center mt2">
          ...
          <p className="text-dark mt1" style={{ fontWeight: 500,fontSize:14 }}>
           {popUpMsg}
          </p>
        </div>
        <div className="mt4">
