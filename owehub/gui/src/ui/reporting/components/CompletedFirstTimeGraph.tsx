    ...
    return (
        <ResponsiveContainer width="95%" height="100%" className={'graph-container'}>
            ...
            <LineChart data={transformedData}  margin={{ top: 10, right: 10, left: 10, bottom: 10 }}>
                <Legend verticalAlign="top"  wrapperStyle={{ paddingBottom: 20,fontSize: 12, width:450, left:80 }} />
                ...
                <Tooltip
                                  ...
                                  />
                <Line type="monotone" dataKey="Albuquerque/El Paso" stroke="#cddc39" strokeWidth={2} dot={{ r: 3, fill: '#cddc39' }} activeDot={{ r: 4, fill: '#cddc39' }} />
                <Line type="monotone" dataKey="Colorado" stroke="#00b6cb" strokeWidth={2} dot={{ r: 3, fill: '#00b6cb' }} activeDot={{ r: 4 }} />
                <Line type="monotone" dataKey="N/A" stroke="#388e3c" strokeWidth={2} dot={{ r: 3, fill: '#388e3c' }} activeDot={{ r: 4 }} />
                <Line type="monotone" dataKey="Peoria/Kingman" stroke="#0072f0" strokeWidth={2} dot={{ r: 3, fill: '#0072f0' }} activeDot={{ r: 4 }} />
                <Line type="monotone" dataKey="Tempe" stroke="#ffd54f" strokeWidth={2} dot={{ r: 3, fill: '#ffd54f' }} activeDot={{ r: 4 }} />
