...
const CustomersList = ({ mapStyles = {} }) => {
    ...
    const customers = [
        { id: 1, name: 'Ashton Sager', email: 'abc@gmail.com', phone: '9289126745' },
        { id: 2, name: 'Santon Sager', email: 'abc@gmail.com', phone: '9289126745' },
        { id: 3, name: 'Ramsto Eager', email: 'abc@gmail.com', phone: '9289126745' },
        { id: 4, name: 'Tagton Sager', email: 'abc@gmail.com', phone: '9289126745' },
        { id: 5, name: 'Ashton Sager', email: 'abc@gmail.com', phone: '9289126745' },
        { id: 6, name: 'Ashton Sager', email: 'abc@gmail.com', phone: '9289126745' },
        { id: 7, name: 'Ashton Sager', email: 'abc@gmail.com', phone: '9289126745' },
      ];
                ...
                <div className={styles.customer_wrapper_list}>
                    ...
                    <div className={styles.cust_det_list}>
                        {customers.map((customer, index) => (
                            <div key={customer.id}  className={`${styles.customer_details} ${openStates[index] ? styles.open : ''}`}>
                                <div className={styles.cust_det_top}>
                                    <div className={styles.cust_name}>
                                        <div style={{ backgroundColor: "#FFEAEA" }} className={styles.name_icon}>
                                            <span>{customer.name.slice(0, 2).toUpperCase()}</span>
                                        </div>
                                        <div className={styles.name}>{customer.name}</div>
                                    </div>
                                    <div className={styles.cust_name}>
                                        <div style={{ backgroundColor: "#E8FFE7", color: "#8BC48A" }} className={styles.name_icon}>
                                            <CiMail size={14} />
                                        </div>
                                    ...
                                    <div className={styles.cust_name}>
                                        <div style={{ backgroundColor: "#EEEBFF", color: "#8E81E0" }} className={styles.name_icon}>
                                            <BiPhone size={14} />
                                        </div>
                                        <div className={styles.head_det}>
                                            <h2>Phone Number</h2>
                                    ...
                                    <div className={styles.cust_name}>
                                        <div style={{ backgroundColor: "#E8FFE7", color: "#8E81E0" }} className={styles.name_icon}>
                                    ...
                                    >
                                        <TbChevronDown
                                            size={22}
                                            style={{
                                                transform: openStates[index] ? 'rotate(180deg)' : undefined,
