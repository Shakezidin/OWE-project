        ...
        <div className={`filter-modal ${isOpen ? 'modal-open' : 'modal-close'} `}>
            ...
            <div className={styles.customer_wrapper_list}>
             ...
             <div className={styles.success_not}>
                ...
                <p>New project is successfully added in the queue, You can directly schedule this project from below.</p>
             </div>

             <div className={styles.survey_button}>
                <button className={styles.self}>Self schedule this survey</button>
                <button className={styles.other} onClick={handleClick}>Schedule this survey for me</button>
             </div>
