  ...
  return (
    <div
      style={{
        ...
        margin: isClicked ? '0px 20px' : '',
      }}
      className="pen-rev"
    >
      <div
        style={{ padding: isClicked ? '15px 17px' : '' }}
        className="pen-rev-top"
      >
        <div
          style={{ paddingTop: isMobile && !isClicked ? '5px' : '' }}
          onClick={isMobile ? onToggleClick : undefined}
          className="pr-namesec"
        >
      ...
      <div
        style={{ display: !isClicked && isMobile ? 'none' : 'block' }}
        className="pen-rev-bot"
      >
        <PendingSurvey />
        <PendingSurvey />
        <PendingSurvey />
