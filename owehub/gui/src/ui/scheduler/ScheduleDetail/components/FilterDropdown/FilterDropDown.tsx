...
const FilterDropDown = ({ onChange }: { onChange?: (str: string[]) => void }) => {
            ...
            {isOpen && (
                <div className={styles.dropdown_container}>
                    <div className="flex items-center">
                        <input
                            checked={
                                (selected.includes('available') && selected.includes('distance')) ||
                    ...
                    <div className="flex items-center">
                        <input
                            className={styles.input_check}
                            checked={selected.includes('available') || selected.includes('all')}
                            onChange={(e) => handleChange(e)}
                            type="checkbox"
                            name="available"
                            id="available"
                    ...
                    <div className="flex items-center">
                        <input
                            className={styles.input_check}
                            onChange={(e) => handleChange(e)}
                            checked={selected.includes('distance') || selected.includes('all')}
                            type="checkbox"
                            name="distance"
                            id="distance"
                        />
