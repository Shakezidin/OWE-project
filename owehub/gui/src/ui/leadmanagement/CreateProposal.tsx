...
<div className={classes.bottomgrid}>
  ...
  <div className={classes.formGroup}>
    ...
    <input 
   className={classes.dropdownModal} type='search' name="search" placeholder='Select an address...'></input>
  </div>

  <div className={classes.formGroup}>
    <label>Project name</label>
    <input className={classes.dropdownModal} type='search' placeholder='Project name' />
  </div>

  <div className={classes.formGroup}>
    <label>*Property type</label>
    <input className={classes.dropdownModal} type='search' placeholder='Select an address...' />
  </div>
