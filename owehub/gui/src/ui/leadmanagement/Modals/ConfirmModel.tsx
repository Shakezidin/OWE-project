...
<div>
    ...
    <div className={classes.customer_wrapper_list}>
        ...
        <>
            <div className={classes.success_not}>
            <div>
                <img className={classes.thumbsImg} onClick={() => setVisibleDiv(4)} height="140px" width="140px" src={SignatureICON} />{' '}
            </div>
            ...
            <span className={classes.getConfirmation}>
                You will receive a reminder <span className={classes.hoursBefore}>24 hrs</span> before
            </span>
        ...
        <>
            ...
            <div className={classes.survey_button}>
            <button
                className={classes.self} onClick={() => setVisibleDiv(6)}
                style={{ backgroundColor: '#3AC759', color:'#FFFFFF', border: 'none' }}
            >
                CLOSED WON
            </button>
            <button onClick={() => setVisibleDiv(5)} id="otherButtonId" style={{ backgroundColor: '#CD4040', color:'#FFFFFF', border: 'none' }} className={classes.other}>
                CLOSED LOST
            </button>
            <button id="otherButtonId" style={{ backgroundColor: '#D3D3D3', color:'#888888', border: 'none' }} className={classes.other}>
                FOLLOW NEEDED
            </button>
        ...
        {visibleDiv === 5 && (
        <>
            <div className={classes.success_not} style={{ backgroundColor: '#FFEDED' }}>
            <div>
