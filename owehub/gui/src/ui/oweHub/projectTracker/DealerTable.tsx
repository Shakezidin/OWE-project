...
const DealerTablePipeline = () => {
  ...
  }, [ page, searchTerm, filters, update]);
  ...
  const getNewFormData = async () => {
    ...
    if (!res.data || !Array.isArray(res.data.primary_sales_rep) || res.data.primary_sales_rep.length === 0) {
      setAmOptions([{ value: "sd", label: "Data Not Found" }]);
      return;
    }
    const newOptions = res.data.primary_sales_rep.map((rep: { name: string; record_id: number }) => ({
      value: rep.record_id,
      label: rep.name,
    }));
  ...
  const handleSetterEdit = async (id: any, old_name: string) => {
    if (selectedAM !== null && selectedAM.value !== '') {
      ...
      const res = await postCaller(EndPoints.update_setter_sales_rep, {
        "project_record_id": String(id),
        "updated_record_id": [String(selectedAM.value)],
        "field": "setter",
        "old_data": old_name,
        "new_data": selectedAM.label
      });
      ...
      // Set a new timeout to reset `update` after 20 seconds
  ...
  const handleRepEdit = async (id: any, old_name: string) => {
    if (selectedSR !== null && selectedSR.value !== '') {
      ...
      const res = await postCaller(EndPoints.update_setter_sales_rep, {
        "project_record_id": String(id),
        "updated_record_id": [String(selectedSR.value)],
        "field": "primary_sales_rep",
        "old_data": old_name,
        "new_data": selectedSR.label
      });
  ...
  const handleRep2Edit = async (id: any, old_name: string) => {
    if (selectedSR2 !== null && selectedSR2.value !== '') {
      ...
      const res = await postCaller(EndPoints.update_setter_sales_rep, {
        "project_record_id": String(id),
        "updated_record_id": [String(selectedSR2.value)],
        "field": "secondary_sales_rep",
        "old_data": old_name,
        "new_data": selectedSR2.label
      });
  ...
  console.log(selectedSR2, selectedSR, selectedAM);
                        ...
                        {selectedSRRow !== item.unique_id ? (
                          ...
                          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                            ...
                            <div
                              ...
                              onClick={() => { setSelectedSRRow(null); handleRepEdit(item.record_id, item.rep_1) }}
                      ...
                      <td>
                        {selectedSR2Row !== item.unique_id ? (
                          ...
                          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                            ...
                            <div
                              className='edit-setter'
                              onClick={() => { setSelectedSR2Row(null); handleRep2Edit(item.record_id, item.rep_2) }}
                              style={{ cursor: "pointer", color: "black", justifyContent: "center" }}
                            >
                              <img src={ICONS.check} alt="" />
                            </div>
                      ...
                      <td>
                        {selectedRow !== item.unique_id ? (
                          ...
                          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                            ...
                            <div
                              className='edit-setter'
                              onClick={() => { setSelectedRow(null); handleSetterEdit(item.record_id, item.setter) }}
                              style={{ cursor: "pointer", color: "black", justifyContent: "center" }}
                            >
                              <img src={ICONS.check} alt="" />
                            </div>
