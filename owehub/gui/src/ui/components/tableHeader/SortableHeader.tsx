...
const SortableHeader: React.FC<SortableHeaderProps> = ({ titleName, sortKey,
  selectAllChecked, selectedRows, setSelectAllChecked, data, isAllRowsSelected, isAnyRowSelected,
  setSelectedRows,
  sortDirection, onClick, isCheckbox
