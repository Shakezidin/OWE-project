...
const VideoPlayer = ({
  ...
  return (
    <div className="transparent-model">
      <div
        className="bg-white"
        style={{ borderRadius: 12, width: '100%', maxWidth: 968 }}
      >
        <div
          ref={containerRef}
          className={`flex flex-column justify-between relative ${styles.container}`}
        >
          <div
            style={{ paddingTop: !isFullscreen ? '.5rem' : undefined }}
            className={`flex  items-center justify-between ${styles.title_wrapper}`}
          >
          ...
          <div
            style={{ marginBlock: isFullscreen ? undefined : '.5rem' }}
          ...
          <div
            style={{ paddingBottom: !isFullscreen ? '.5rem' : undefined }}
              ...
              <div className={styles.flexCenter}>
                ...
                <div className={styles.flexCenter}>
                  <button onClick={toggleMute} className={styles.button}>
                    {volume === 0 ? (
                      <PiSpeakerSimpleXFill color="#fff" />
                    ) : (
                      <PiSpeakerSimpleHighFill color="#fff" />
                    )}
                  </button>
                  <input
                    type="range"
