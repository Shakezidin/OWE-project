...
func HandleUpdateCommissionArchiveRequest(resp http.ResponseWriter, req *http.Request) {
	...
	if err != nil {
		...
		FormAndSendHttpResp(resp, "Failed to unmarshal update commissions Archive request", http.StatusBadRequest, nil)
		return
	}
	...
	FormAndSendHttpResp(resp, "Commissions Archive Updated Successfully", http.StatusOK, nil)
}
