...
// 		SiteSurverCompleteDate, ok := item["survey_final_completion_date"].(time.Time)
// 		if !ok {
...
// 		PlanSetCompleteDate, ok := item["cad_complete_date"].(time.Time)
// 		if !ok {
...
// 		PermitApprovedDate, ok := item["permit_approval_date"].(time.Time)
// 		if !ok {
...
// 		IcAPprovedDate, ok := item["ic_approval_date"].(time.Time)
// 		if !ok {
...
// 		PvInstallCompletedDate, ok := item["install_completed_date"].(time.Time)
// 		if !ok {
// 			// log.FuncErrorTrace(0, "Failed to get active date for Unique ID %v. Item: %+v\n", UniqueId, item)
// 			PvInstallCompleteD = ""
// 		} else {
...
// 		PtoDate, ok := item["pto_granted_new"].(time.Time)
// 		if !ok {
// 			// log.FuncErrorTrace(0, "Failed to get active date for Unique ID %v. Item: %+v\n", UniqueId, item)
// 			PTOD = ""
// 		} else {
...
// 		ContractDate, ok := item["sale_date"].(time.Time)
// 		if !ok {
// 			// log.FuncErrorTrace(0, "Failed to get PtoDate for Unique ID %v. Item: %+v\n", UniqueId, item)
// 			contractD = ""
// 		} else {
