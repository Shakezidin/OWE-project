...
/******************************************************************************
 * FUNCTION:		HandleRepStatusArchiveRequest
 * DESCRIPTION:     handler for  RepStatus Archive request
 * INPUT:			resp, req
 * RETURNS:    		void
 ******************************************************************************/
...
func HandleRepStatusArchiveRequest(resp http.ResponseWriter, req *http.Request) {
	...
	log.EnterFn(0, "HandleRepStatusArchiveRequest")
	defer func() { log.ExitFn(0, "HandleRepStatusArchiveRequest", err) }()
	...
	for _, id := range RepStatusArcReq.RecordId {
	...
	queryParameters = append(queryParameters, RepStatusArcReq.IsArchived)
