...
func HandleGetApRepDataRequest(resp http.ResponseWriter, req *http.Request) {
	...
	if err != nil {
		...
		FormAndSendHttpResp(resp, "Failed to unmarshal get ap rep data Request body", http.StatusBadRequest, nil)
		return
	}
	...
	if err != nil {
		...
		FormAndSendHttpResp(resp, "Failed to get ap rep data from DB", http.StatusBadRequest, nil)
		return
	}
	...
	FormAndSendHttpResp(resp, "ap rep Data", http.StatusOK, apRepList, RecordCount)
}
