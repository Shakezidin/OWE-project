...
func HandleUpdateRateAdjustmentsArchiveRequest(resp http.ResponseWriter, req *http.Request) {
	...
	if err != nil {
		...
		FormAndSendHttpResp(resp, "Failed to unmarshal update RateAdjustments Archive request", http.StatusBadRequest, nil)
		return
	}
	...
	FormAndSendHttpResp(resp, "RateAdjustments Archive Updated Succesfully", http.StatusOK, nil)
}
