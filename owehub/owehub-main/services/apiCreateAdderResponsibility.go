...
func HandleCreateAdderResponsibilityDataRequest(resp http.ResponseWriter, req *http.Request) {
	...
	if err != nil {
		...
		FormAndSendHttpResp(resp, "Failed to unmarshal create adder responsibility request", http.StatusBadRequest, nil)
		return
	}
	...
	FormAndSendHttpResp(resp, "adder responsibility Created Successfully", http.StatusOK, nil)
}
