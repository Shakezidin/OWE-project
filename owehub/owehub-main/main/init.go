...
var apiRoutes = ApiRoutes{
	...
	{
		strings.ToUpper("POST"),
		"/owe-commisions-service/v1/get_sale_reps",
		apiHandler.HandleGetSaleRepDataRequest,
		true,
		[]types.UserGroup{types.GroupAdmin},
	},
	{
		strings.ToUpper("POST"),
		"/owe-commisions-service/v1/manage_team",
		apiHandler.HandleManageTeamDataRequest,
		true,
		[]types.UserGroup{types.GroupAdmin},
	},
	{
