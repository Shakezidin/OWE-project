...
var apiRoutes = appserver.ApiRoutes{
	...
	{
		strings.ToUpper("POST"),
		"/owe-main-service/v1/create_slack_config",
	...
	{
		strings.ToUpper("POST"),
		"/owe-main-service/v1/update_slack_config",
	...
	{
		strings.ToUpper("POST"),
		"/owe-main-service/v1/update_slack_config_archive",
	...
	{
		strings.ToUpper("POST"),
		"/owe-main-service/v1/get_slack_config",
	...
	{
		strings.ToUpper("POST"),
		"/owe-main-service/v1/delete_slack_config",
