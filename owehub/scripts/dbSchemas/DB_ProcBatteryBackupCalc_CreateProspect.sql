...
*/ 
    INSERT INTO prospects_info (prospect_name, sr_email_id, panel_images_url, water_heater,cooking_appliances, furnace, clothes_dryer, pool_pump, well_pump, ev_charger ,spa)
    VALUES (prospect_name, sr_email_id, panel_images_url, water_heater,cooking_appliances, furnace, clothes_dryer, pool_pump, well_pump, ev_charger ,spa)
