...
var apiRoutes = appserver.ApiRoutes{
	...
	{
		strings.ToUpper("POST"),
		"/owe-reports-service/v1/get_speedsaletoinstallsummaryreport",
	...
	{
		strings.ToUpper("POST"),
		"/owe-reports-service/v1/get_ftc_qualityperoffice_summaryreport",
	...
	{
		strings.ToUpper("POST"),
		"/owe-reports-service/v1/get_ftc_reasonforincomplete_summaryreport",
	...
	{
		strings.ToUpper("POST"),
		"/owe-reports-service/v1/get_report_by_id",
		apiHandler.HandleGetReportById,
		true,
		[]types.UserGroup{types.GroupAdmin},
	},
	{
	...
	{
		strings.ToUpper("POST"),
		"/owe-reports-service/v1/get_tab_notes_info",
		apiHandler.HandleGetTabNotesInfoRequest,
		true,
		[]types.UserGroup{types.GroupAdmin},
	},
	{
		strings.ToUpper("POST"),
		"/owe-reports-service/v1/get_tab_other_info",
		apiHandler.HandleGetTabOtherInfoRequest,
		true,
		[]types.UserGroup{types.GroupAdmin},
	},
	{
		strings.ToUpper("POST"),
		"/owe-reports-service/v1/update_dat_tool_info",
		apiHandler.HandleUpdateDatToolRequest,
		true,
		[]types.UserGroup{types.GroupAdmin},
	},
	{
		strings.ToUpper("POST"),
		"/owe-reports-service/v1/get_drop_down_list",
		apiHandler.HandleGetDropDownListRequest,
		true,
		[]types.UserGroup{types.GroupAdmin},
	},
	{
