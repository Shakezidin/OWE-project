/**************************************************************************
 *	Function	: createLoanFeeAdderApiModels.go
 *	DESCRIPTION : Files contains struct for create LoanFeeAdder models
 *	DATE        : 24-Apr-2024
 **************************************************************************/

package models

type CreateLoanFeeAdder struct {
...
type UpdateLoanFeeAdderArchive struct {
