...
func HandleCreateTimelineSlaRequest(resp http.ResponseWriter, req *http.Request) {
	...
	if err != nil {
		...
		FormAndSendHttpResp(resp, "Failed to unmarshal create timeline sla request", http.StatusBadRequest, nil)
		return
	}
	...
	FormAndSendHttpResp(resp, "timeline sla Created Sucessfully", http.StatusOK, nil)
}
