...
func HandleCreateCommissionRequest(resp http.ResponseWriter, req *http.Request) {
	...
	if err != nil {
		...
		FormAndSendHttpResp(resp, "Failed to unmarshal create commissions request", http.StatusBadRequest, nil)
		return
	}
	...
	queryParameters = append(queryParameters, createCommissionReq.StartDate)
	...
	FormAndSendHttpResp(resp, "Commissions Created Sucessfully", http.StatusOK, nil)
}
