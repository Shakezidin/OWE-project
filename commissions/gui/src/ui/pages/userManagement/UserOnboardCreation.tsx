...
import { dealer, userSelectData } from "../../../resources/static_data/StaticData";
              ...
              <div className="create-input-container">
                ...
                <div className="create-input-field">
                  ...
                  <Select
                    ...
                    value={userSelectData?.find((option) => option?.value === createUserOnboarding.role_name)}
                    styles={{
              ...
              <div className="create-input-container">
                ...
                <div className="create-input-field">
                  ...
                  <Select
                    options={dealer}
                    isSearchable
                    onChange={(newValue) => handleChange(newValue, 'assigned_dealer_name')}
                    value={dealer?.find((option) => option?.value === createUserOnboarding.assigned_dealer_name)}
                    styles={{
                      control: (baseStyles, state) => ({
                        ...baseStyles,
                        marginTop: "4.5px",
