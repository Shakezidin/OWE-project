...
const AppSetterOnboardCreation = (props:ButtonProps) => {
    ...
    <div className="transparent-model">
      <div className="modal">
        ...
        <div className="createUserContainer">
          <h3 className="createProfileText">Appt Setter Onboarding</h3>
            ...
            <div className="createProfileTextView">
              ...
              <div className="create-input-field">
                ...
                <div className="create-input-field">
                   ...
                   label="Role"
                   value={""}
                   options={['Select Role', 'Dealer Owner', 'Regional Manger','Sales Manager', 'Sales Representative','Admin']}
...
export default AppSetterOnboardCreation;
