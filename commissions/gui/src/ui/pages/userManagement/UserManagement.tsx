    ...
    <>
      <div className="onboardrow">
        <div className="onboardcol btnone">
          <button onClick={handleOpen}>
            <span> + </span> <div className="txt">Create</div>{" "}
            <div className="boldtxt">User Onboarding</div>{" "}
          </button>
        ...
        <div className="onboardcol btntwo">
          <button onClick={handleOpen1}>
            <span> + </span> <div className="txt">Create</div>{" "}
            <div className="boldtxt">Appt Setter Onboarding</div>{" "}
          </button>
        ...
        <div className="onboardcol btnthree">
          <button onClick={handleOpen}>
            <span> + </span> <div className="txt">Create</div>{" "}
            <div className="boldtxt">Partner Onboarding</div>{" "}
          </button>
        </div>
      </div>
      ...
      <div className="graphbar">
        ...
        <div className="charbarrow">
          ...
          <div className="zero gline">0</div>
          <div className="twenty gline">20</div>
          <div className="fourty gline">40</div>
          <div className="sixty gline">60</div>
          <div className="eighty gline">80</div>
          <div className="hundred gline">100</div>
        </div>
      </div>
          ...
          <table>
            <thead style={{ background: "#FCFCFD" }}>
              <tr>
                ...
                <th>
                  Name <img src={arrowDown} alt="" />
                </th>
                <th>
                  Pay Rate <img src={arrowDown} alt="" />
                </th>

                <th>
                  Descriptions <img src={arrowDown} alt="" />
                </th>
                <th>
                  Start Date <img src={arrowDown} alt="" />
                </th>
                <th>
                  End Date <img src={arrowDown} alt="" />
                </th>
                <th>
