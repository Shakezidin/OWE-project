...
import { FiCalendar, FiChevronLeft, FiChevronRight, FiXCircle } from 'react-icons/fi';
const ProjectPerformence = () => {
  ...
  return (
    <div className="" >
      ...
      {showCalendar && (
        <div className="calendar-container">
          <div className="calendar-header">
            <FiChevronLeft onClick={() => setStartDate(new Date(startDate!.getFullYear(), startDate!.getMonth() - 1, startDate!.getDate()))} />
            <div className="month-year">
              {startDate && startDate.toLocaleString('default', { month: 'long', year: 'numeric' })}
            </div>
            <FiChevronRight onClick={() => setStartDate(new Date(startDate!.getFullYear(), startDate!.getMonth() + 1, startDate!.getDate()))} />
          </div>
          <DatePicker
            selected={startDate}
          ...
          />
          <button className="reset-button" onClick={resetDates}>Reset</button>
        </div>
      )}
    </div>
            {/* <button type="button" >
      ...
      <div className="project-container" style={{ marginTop: "1rem", padding:"0 0 1rem 0" }}>
