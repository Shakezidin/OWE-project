...
import { fetchUserListBasedOnRole, fetchUserOnboarding } from "../../apiActions/userManagementActions";
...
const userManagementSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      //get user based list
      .addCase(fetchUserListBasedOnRole.pending, (state: UserOnboardingStateModel) => {
        state.loading = true;
        state.error = null;
      })
      .addCase(fetchUserListBasedOnRole.fulfilled, (state: UserOnboardingStateModel, action) => {
        state.loading = false;
        state.error = null;
        state.userRoleBasedList = action.payload;
      })
      .addCase(fetchUserListBasedOnRole.rejected, (state:UserOnboardingStateModel, action) => {
        state.loading = false;
