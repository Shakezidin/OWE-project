...
export const MarketingFeesColumn: Column[] = [
    ...
    { name: "fee_rate", displayName: "Fee Rate", type: "string",isCheckbox:false },
    { name: "chg_dlr", displayName: "Chg Dlr", type: "number",isCheckbox:false },
    { name: "pay_src", displayName: "Pay Src", type: "number" ,isCheckbox:false},
