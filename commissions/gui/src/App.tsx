...
import MarktingFees from './ui/pages/configure/marketingFees/MarketingFees';
        ...
        <Provider store={store}>
          <BrowserRouter>
            <Routes>
              ...
              <Route path='/configure/marketing_fees' element={<ProtectedRoute Children={<MarktingFees />} />} />
            </Routes>
          </BrowserRouter>
        </Provider>
      </AuthProvider>
